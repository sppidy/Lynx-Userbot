...
CMD_HELP.update(
    {
        ...
        "\n↳ : __Mempromosikan member sebagai admin.__"
        "\n\n⚡**CMD**⚡: `.demote` <username/balas ke pesan>"
        "\n↳ : __Menurunkan admin sebagai member.__"
        "\n\n⚡**CMD**⚡: `.ban` <username/balas ke pesan> <alasan (optional)>"
        "\n↳ : __Memblokir Seseorang.__"
        "\n\n⚡**CMD**⚡: `.unban <username/reply>`"
        "\n↳ : __Menghapus Blokir.__"
        "\n\n⚡**CMD**⚡: `.mute` <username/balas ke pesan> <alasan (optional)>"
        "\n↳ : __Membisukan Seseorang Di Grup, Bisa Ke Admin Juga.__"
        "\n\n⚡**CMD**⚡: `.unmute` <username/balas ke pesan>"
        "\n↳ : __Membuka bisu orang yang dibisukan.__"
        "\n\n⚡**CMD**⚡: `.gmute` <username/balas ke pesan> <alasan (optional)>"
        "\n↳ : __Membisukan ke semua grup yang kamu punya sebagai admin.__"
        "\n\n⚡**CMD**⚡: `.ungmute` <username/reply>"
        "\n↳ : __Reply someone's message with__ `.ungmute` __to remove them from the gmuted list.__"
        "\n\n⚡**CMD**⚡: `.zombies`"
        "\n↳ : __Untuk mencari akun terhapus dalam grup.__"
        "__Gunakan__ `.zombies clean` __untuk menghapus Akun Terhapus dari grup.__"
        "\n\n⚡**CMD**⚡: `.all`"
        "\n↳ : __Tag semua member dalam grup.__"
        "\n\n⚡**CMD**⚡: `.admins`"
        ...
        "\n↳ : __Mengganti foto profil grup.__"})
