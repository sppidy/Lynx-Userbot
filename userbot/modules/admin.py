...
async def rm_deletedacc(show):
    ...
    # Well
    if not admin and not creator:
        return await show.edit("`Mohon Maaf, Yang Mulia Bukan Admin Disini!`")
...
async def get_bots(show):
    ...
    try:
        ...
        await show.edit("Yang Mulia, Terlalu Banyak Bot Di Grup Ini, Mengunggah Daftar Bot Sebagai File.")
...
CMD_HELP.update(
    {
        ...
        "\n\n⚡𝘾𝙈𝘿⚡: `.ban` <username/balas ke pesan> <alasan (optional)>"
        "\n↳ : Memblokir Seseorang."
        "\n\n⚡𝘾𝙈𝘿⚡: `.unban <username/reply>`"
        "\n↳ : Menghapus Blokir."
        "\n\n⚡𝘾𝙈𝘿⚡: `.mute` <username/balas ke pesan> <alasan (optional)>"
        "\n↳ : Membisukan Seseorang Di Grup, Bisa Ke Admin Juga."
        "\n\n⚡𝘾𝙈𝘿⚡: `.unmute` <username/balas ke pesan>"
        "\n↳ : Membuka bisu orang yang dibisukan."
        "\n\n⚡𝘾𝙈𝘿⚡: `.gmute` <username/balas ke pesan> <alasan (optional)>"
